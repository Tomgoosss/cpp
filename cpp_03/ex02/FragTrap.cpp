...
void FragTrap::highFivesGuys(void)
{
    if (_hitPoints == 0)
    {
        std::cout << "FragTrap " << _name << " can't request a high five, it's out of hit points!" << std::endl;
        return;
    }
    if (_energyPoints == 0)
    {
        std::cout << "FragTrap " << _name << " can't request a high five, no energy left!" << std::endl;
        return;
    }
